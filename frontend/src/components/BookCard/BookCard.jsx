...
const BookCard = ({ data, favourite }) => {
  ...
  return (
    <div className="bg-gradient-to-tl from-gray-900 via-gray-700 to-gray-500 rounded-lg p-4 flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-sm mx-auto">
