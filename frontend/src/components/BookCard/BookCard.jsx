...
const BookCard = ({ data, favourite }) => {
  ...
  return (
    <div className="bg-gradient-to-tl from-stone-700 via-zinc-800 to-zinc-900 rounded-lg p-4 flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-sm mx-auto">
