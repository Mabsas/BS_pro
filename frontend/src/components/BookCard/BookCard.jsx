...
const BookCard = ({ data, favourite }) => {
  ...
  return (
    <div className="bg-gradient-to-b from-zinc-500 to-zinc-700 rounded-lg p-4 flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-sm mx-auto">
